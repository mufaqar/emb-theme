    ...
    <form class="add_ticket" id="add_ticket" action="#" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="d-flex justify-content-end savebtn">
                    <input type="submit" class="btn_primary"  value="Add User"/>
                </div>
            </div>
        </form>
    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="content mt-5">
                            ...
                            <h2 class="mb-5 mt-5">We Have Create User For you</h2>
                        </div>
                    </div>
 ...
 <script type="text/javascript">   
     jQuery(document).ready(function($) {	
        ...
        $("#add_ticket").submit(function(e) {                     
            ...
            form_data.append('action', 'add_personal');
