<?php /* Template Name: admin-editLocation  */ 
get_header();
$tid = $_REQUEST['tid'];
$term = get_term($tid);
$term_name = $term->name; 
    ...
    <input type="hidden" value="<?php echo $tid ?>" id="tid" >
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="_select">
                        <input type="text" value="<?php echo $term_name ?>" placeholder="Please enter name" id="name" required>
                    </div>
                </div>              

                <div class="d-flex justify-content-end savebtn">
                    <input type="submit" class="btn_primary"  value="Update Floor Section"/>
                </div>
            </div>
        </form>
    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="content mt-5">
                            ...
                            <h2 class="mb-5 mt-5">We Have Update Location For you</h2>
                        </div>
                    </div>
 ...
 <script type="text/javascript">   
     jQuery(document).ready(function($) {	
        ...
        $("#add_ticket").submit(function(e) {                     
            ...
            form_data.append('action', 'update_location');
