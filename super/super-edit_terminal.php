<?php /* Template Name: Admin-EditTerminal  */
get_header();
    ...
    <input type="hidden" value="<?php echo $pid ?>" id="pid" >
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="_select">
                        <input type="text" value="<?php echo $terminal_devnum ?>" placeholder="Please enter Dev Number" id="devnum" required>
                    </div>
                </div>  
                <div class="col-md-6 mb-3">
                    <label for="">Dev Name </label>
                    <div class="_select">
                        <input type="text" value="<?php echo $terminal_devname ?>" placeholder="Please enter Dev name" id="devname" required>
                    </div>
                </div>  
                <div class="col-md-6 mb-3">
                ...
                <div class="d-flex justify-content-end savebtn">
                    <input type="submit" class="btn_primary"  value="Update Terminal"/>
                </div>
            </div>
        </form>
    </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="content mt-5">
                            ...
                            <h2 class="mb-5 mt-5">We Have Update Terimianl </h2>
                        </div>
                    </div>
 ...
 <script type="text/javascript">   
     jQuery(document).ready(function($) {	
        ...
        $("#add_ticket").submit(function(e) {                     
            ...
            form_data.append('action', 'update_terminal');
